export const releaseConfig = Object.freeze({
  ...
  identities: {
    online: {
      characterVersion: 'Z6.1-landlord-os-online-preview.18',
      cardName: '房东模拟器 Z6.1｜Landlord OS·在线技术预览 0.3.0-18',
      worldbookName: '房东模拟器·世界书｜Z6.1-LandlordOS-在线-0.3.0-18',
      artifactFile: '房东模拟器Z6.1-LandlordOS-在线技术预览版-v0.3.0-preview.18.json',
    },
    offline: {
      characterVersion: 'Z6.1-landlord-os-offline-preview.18',
      cardName: '房东模拟器 Z6.1｜Landlord OS·离线技术预览 0.3.0-18',
      worldbookName: '房东模拟器·世界书｜Z6.1-LandlordOS-离线-0.3.0-18',
      artifactFile: '房东模拟器Z6.1-LandlordOS-离线技术预览版-v0.3.0-preview.18.json',
    },
  },
  upstreams: {
    mvuFramework: {
