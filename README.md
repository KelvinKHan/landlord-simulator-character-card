...
当前开发预览为 **v0.3.0-preview.1 / Z6.1 Landlord OS**：新增本地/AI 双模式任务中心、正文/微信/新闻/建筑联动队列、逐步感知、租客统一身份与建筑数字孪生底座。详见 [`docs/v0.3.0-preview.1-实现说明.md`](docs/v0.3.0-preview.1-实现说明.md)。
