...
脚本的长期结构和扩展新玩法的规则见 [`scripts/ARCHITECTURE.md`](scripts/ARCHITECTURE.md)。当前聊天数据库、AI 聊天核心、正文联动、微信 APP、分析调度器和队列组件已经迁入标准模块；聊天数据、AI 生成、世界书同步与界面不再互相修改全局实现，其他旧模块按依赖顺序逐步迁移。
