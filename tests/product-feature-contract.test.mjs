...
test('经营中枢构建产物包含所有可玩流程且明确显示本地模拟模式', () => {
  for (const marker of [
    ...
    'data-radar-building',
    'RESIDENT PLACEMENT LAB',
    '跨建筑人才匹配矩阵',
    'data-assignment-signature',
    ...
    '建筑人流波形',
    'LIFE COLLISION ORACLE',
    '跨世界生活交汇预言机',
    'data-collision-oracle',
    'data-collision-kind',
    'choose-life-collision',
    'confirm-life-collision',
    'ENCOUNTER → ARCHITECTURE',
    '跨世界共创装修',
    'data-co-creation-lab',
    'data-co-creation-project',
    'data-co-creation-plan',
    'run-co-creation',
    'confirm-co-creation',
    '建筑接管提案',
